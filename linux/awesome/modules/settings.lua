...
settings.default_apps.terminal = "x-terminal-emulator"
settings.default_apps.editor = os.getenv("EDITOR") or "nvim"
settings.default_apps.editor_cmd = settings.default_apps.terminal .. " -e " .. settings.default_apps.editor
settings.default_apps.browser = "firefox"
